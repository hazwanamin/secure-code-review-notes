...
Built as part of an AppSec transition portfolio.



\## Python

\- \[01 - SQL Injection](./python/01-sql-injection.md)

\- \[02 - Hardcoded Secrets](./python/02-hardcoded-secrets.md)

\- \[03 - Command Injection](./python/03-command-injection.md)



\## JavaScript / Node.js

\- \[01 - Prototype Pollution](./javascript/01-prototype-pollution.md)
